...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(ClienteProdutoNotFoundException.class)
    public ResponseEntity<?> clientNotFoundException(ClienteProdutoNotFoundException ex,HttpServletResponse response) {
